...
if __name__ == '__main__':
    ...
    parser.add_argument('--smatPath', help="Absolute path of locally installed Symbolic Music Alignment Tool folder",
                        required=True)
    ...
    parser.add_argument('--structureUri',
                        help="URI of the structural segmentation RDF for the MEI file being performed", required=True)
    parser.add_argument('--scoreUri', help="URI of the conceptual score RDF for the MEI file being performed",
                        required=True)
    parser.add_argument('--audioContainer', help="URI of the Solid Container that will host the synthesised audio",
                        required=True)
    parser.add_argument('--solidContainer', help="URI of base CLARA folder in user's SOLID Pod", required=True)
    parser.add_argument('--tpl-out', help="File used by TROMPA Processing Library to identify the segment RDF output",
                        required=True)
    parser.add_argument('--uuid', help="UUID for generated output. If not provided, a new one will be generated",
                        required=False)
